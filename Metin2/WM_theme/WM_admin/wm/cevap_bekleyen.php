                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
									...
									<div class="panel panel-default">
												...
												Cevap Bekleyen Bildirimleri Görüntülüyorsunuz.
                                    ...
                                    <table class="table" id="karaktersirala">
                                        ...
                                        <tbody>
											...
											WHERE (destek.sid = ? && destek_kategori.sid = ?) && (destek.durum = ? || destek.durum = ?) ORDER BY destek.id DESC");
											$query->execute(array($_SESSION["server"], $_SESSION["server"], 0, 2));
											$i = 0;
