                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
									...
									<div class="panel panel-default">
												...
												Ödemesi Onaylanmış Bildirimler
                                    ...
                                    <table class="table" id="karaktersirala">
                                        ...
                                        <tbody>
											...
											WHERE (destek.sid = ? && destek_kategori.sid = ?) && (destek.durum = ?) ORDER BY destek.id DESC");
											$query->execute(array($_SESSION["server"], $_SESSION["server"], 5));
											$i = 0;
