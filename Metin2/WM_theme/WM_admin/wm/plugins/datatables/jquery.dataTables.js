...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "Listelenecek Veri Bulunamadı" )
		{
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Arancak Değeri Giriniz" class="'+classes.sFilterInput+'"/>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": "Listelenecek Veri Bulunamadı",
			 ...
			 *    } );
			 */
			"sInfo": "Sayfa Başı :  _START_ Sayfa Sonu : _END_ Toplam Veri :  _TOTAL_",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(_MAX_ veri içinde arama gerçekleştirildi.)",
			 ...
			 *    } );
			 */
			"sZeroRecords": "Aradığınız veriye ait sonuç bulunamadı"
		},
