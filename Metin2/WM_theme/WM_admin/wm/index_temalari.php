...
<?php if($WMadmin->ayarlar("index_tema") == $file){?>
<p class="sr-item-links"><a class="btn btn-danger btn-lg btn-block"><i class="fa fa-check"></i> Varsayılan Tema</a></p>
<?php }else{ ?>
<p class="sr-item-links"><a onclick="WM_click('tema_ayarlari&formid=4&tema=<?=$file;?>')" href="javascript:;" class="btn btn-success btn-lg btn-block"><i class="fa fa-save"></i> Tema Olarak Kaydet</a></p>
<?php } ?>
</div>	
