...
if ( !server_kontrol || server_kontrol == '' || !isset( $_SESSION[ "market_user" ] ) || !isset( $_SESSION[ "market_token" ] ) || !isset( $_SESSION[ "market_userid" ] ) ) {
    if ( isset( $_POST[ "girisyap" ] ) ) {
        ...
        $password = $WMkontrol->WM_post( $WMkontrol->WM_html( $WMkontrol->WM_tostring( $_POST[ "password" ] ) ) );
    ...
    define( 'WM_market', '../WM_theme/WM_market/' . $tema );
    @$kategori_get = $WMkontrol->WM_get( $WMkontrol->WM_html( $_GET[ "kategori" ] ) );
    @$sayfalar = $WMkontrol->WM_get( $WMkontrol->WM_html( $_GET[ "sayfa" ] ) );
    if ( !$sayfalar ) {
