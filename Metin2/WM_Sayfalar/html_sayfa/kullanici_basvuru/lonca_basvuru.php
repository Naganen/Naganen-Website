...
<table border="0" align="center" width="100%">
	    <tr>
      <td align="center"><label>Lonca isminizi giriniz : <span style="color:darkred;text-shadow:none;">*</span><br>
		<input type="hidden" name="basvuru_token" value="<?=$ayar->sessionid;?>">
        <input name="lonca_isim" type="text">
      </label></td>
    </tr>
		<tr>
		<td align="center">
    ...
    <tr>
      <td align="center">
	  <br>
	  <input type="submit" name="lonca_basvur" value="Başvur"></td>
    </tr>
</table>
