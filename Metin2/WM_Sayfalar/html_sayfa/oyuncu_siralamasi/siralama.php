...
<table width="100%" border="0" align="center" cellpadding="2" class="siralama" style="margin-top:25px;">
  <tbody><tr>
    ...
    <th width="15%" align="center"><h5>Sınıf</h5></th>
    <th width="20%" align="center"><h5>Bayrak</h5></th>
    <th width="30%" align="center"><h5>Lonca</h5></th>
	<th width="10%" align="center"><h5>Durum</h5></th>
  </tr>
    ...
    <tr>
      ...
      <td width="30%" align="center"><?=($row["lonca"] == "") ? '<span style="color:red">Yok<span></span>' : '<a href="lonca/'.$row["lonca"].'">'.$row["lonca"].'</a>';?></span></td>
