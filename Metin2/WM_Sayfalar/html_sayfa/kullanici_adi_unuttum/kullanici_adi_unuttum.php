...
<table border="0" align="center" width="100%">
	    <tr>
      <td align="center"><label>Email Adresinizi Giriniz<span style="color:darkred;text-shadow:none;">*</span><br>
		<input type="hidden" name="kullanici_unuttum_token" value="<?=$ayar->sessionid;?>">
    ...
    <tr>
      <td align="center">
	  <br>
	  <input type="submit" name="kullanici_adimi_unuttum" value="Değiştir"></td>
    </tr>
</table>
