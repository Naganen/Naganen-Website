...
if ( $arama == 1 ) {
    ...
    if ( $kontrol->rowCount() ) {
        $WMadmin->yonlendir( "index.php?sayfa=kullanici_ara&tur=1&deger=$deger" );
    } else {
    ...
    if ( $kontrol->rowCount() ) {
        $WMadmin->yonlendir( "index.php?sayfa=kullanici_ara&tur=2&deger=$deger" );
    } else {
        $WMform->hata( "Arama kriterine uygun karakter bulunamadı" );
    }
} else if ( $arama == 3 ) {
    ...
    if ( $kontrol->rowCount() ) {
        $WMadmin->yonlendir( "index.php?sayfa=kullanici_ara&tur=3&deger=$deger" );
    } else {
        $WMform->hata( "Arama kriterine uygun karakter bulunamadı" );
    }
} else if ( $arama == 4 ) {
    ...
    if ( $kontrol->rowCount() ) {
        $WMadmin->yonlendir( "index.php?sayfa=kullanici_ara&tur=4&deger=$deger" );
    } else {
        $WMform->hata( "Arama kriterine uygun karakter bulunamadı" );
    }
} else if ( $arama == 5 ) {
    ...
    if ( $kontrol->rowCount() ) {
        $WMadmin->yonlendir( "index.php?sayfa=kullanici_ara&tur=5&deger=$deger" );
    } else {
        $WMform->hata( "Arama kriterine uygun karakter bulunamadı" );
    }
}
